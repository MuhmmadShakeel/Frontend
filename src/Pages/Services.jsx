        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative py-8 lg:py-12 overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-10 left-10 w-20 h-20 bg-[#FFB900] rounded-full blur-xl"></div>
                    <div className="absolute top-40 right-20 w-16 h-16 bg-[#FFB900] rounded-full blur-lg"></div>
                    <div className="absolute bottom-20 left-1/3 w-24 h-24 bg-[#FFB900] rounded-full blur-xl"></div>
                </div>
                
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div className="text-center" data-aos="fade-up">
                        <h1 className="text-5xl lg:text-7xl font-bold mb-6 tracking-tight text-[#090447]">
                            Our <span className="text-[#FFB900]">Services</span>
                        </h1>
                        <p className="text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxedmb-8 text-gray-500">
                            Professional solutions for your digital transformation journey.We are here to deliver and explore the tech with you
                        </p>
            ...
            <div className="py-2 lg:py-12 bg-gradient-to-br from-gray-50 to-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {featuredServices.map((service, index) => (
                        <div 
                            key={service.id} 
                            className={`flex flex-col lg:flex-row items-center gap-10 lg:gap-16 mb-20 lg:mb-24 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}
                            data-aos="fade-up"
                        ...
                        >
                            ...
                            <div className="lg:w-1/2 w-full" data-aos={index % 2 === 0 ? "fade-right" : "fade-left"}>
                                <div className="relative group">
                                    <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                                        ...
                                        <div className="absolute bottom-4 left-4 bg-[#FFB900] text-[#090447] px-4 py-2 rounded-xl font-bold text-lg">
                                            Featured
                                        </div>
                                    </div>
                            ...
                            <div className="lg:w-1/2 w-full" data-aos={index % 2 === 0 ? "fade-left" : "fade-right"}>
                                <div className="bg-gradient-to-br from-[#090447] to-[#0d0a5c] p-8 lg:p-10 rounded-3xl shadow-2xl border border-[#FFB900]/20 relative overflow-hidden">
                                    {/* Background Pattern */}
                                    ...
                                    <h3 className="text-3xl lg:text-4xl font-bold mb-6 text-white relative">
                                        {service.title}
                                    </h3>
                                    <p className="text-gray-200 mb-8 leading-relaxed text-lg relative">
                                        {service.description}
                                    </p>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 relative">
                                        <button 
                                            ...
                                            className="bg-[#FFB900] hover:bg-[#e6a700] text-[#090447] font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg text-lg flex-1"
                                        >
                                            Learn More
                                        </button>
                                    </div>
            ...
            {/* All Services Grid */}
            <div className="py-16 lg:py-24 bg-gradient-to-br from-[#090447] to-[#0d0a5c] relative overflow-hidden">
                {/* Background Elements */}
                <div className="absolute inset-0 opacity-5">
                    <div className="absolute top-20 right-10 w-40 h-40 bg-[#FFB900] rounded-full blur-3xl"></div>
                    <div className="absolute bottom-20 left-10 w-32 h-32 bg-[#FFB900] rounded-full blur-2xl"></div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service, index) => (
                            <div 
                                key={service.id} 
                                className="group relative bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-2xl hover:shadow-3xl border border-gray-200 hover:border-[#FFB900] transition-all duration-500 overflow-hidden transform hover:-translate-y-3"
                                data-aos="fade-up"
                            ...
                            >
                                ...
                                <div className="h-48 overflow-hidden relative">
                                    ...
                                    <div className="absolute top-4 right-4 w-12 h-12 bg-[#090447] backdrop-blur-sm rounded-xl flex items-center justify-center text-white text-xl shadow-lg">
                                        {serviceDetails[service.id]?.icon}
                                    </div>
                                    <div className="absolute bottom-4 left-4">
                                        <span className="bg-[#FFB900] text-[#090447] px-3 py-1 rounded-lg font-bold text-sm">
                                            Popular
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="p-6 lg:p-8 bg-gradient-to-br from-[#090447] to-[#0d0a5c] h-48 flex flex-col justify-between">
                                    <div>
                                        <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#FFB900] transition-colors duration-300">
                                            {service.title}
                                        </h3>
                                    ...
                                    <button 
                                        onClick={() => setSelectedService(service)}
                                        className="w-full bg-[#FFB900] hover:bg-[#e6a700] text-[#090447] font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-2 group/btn mt-4"
                                    >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
                        ...
                        <div data-aos="fade-right">
                            ...
                            <div className="space-y-6">
                                {/* Phone */}
                                <div className="group flex items-start space-x-6 p-6 rounded-2xl bg-white hover:bg-gradient-to-r hover:from-[#090447] hover:to-[#0d0a5c] border border-gray-200 hover:border-[#FFB900] transition-all duration-500 transform hover:scale-105 shadow-lg hover:shadow-2xl">
                                    <div className="flex-shrink-0 w-14 h-14 bg-[#090447] group-hover:bg-[#FFB900] rounded-2xl flex items-center justify-center text-white transform group-hover:scale-110 transition-all duration-300 shadow-2xl">
                                        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                        </svg>
                                    </div>
                                    <div>
                                        <h4 className="font-bold mb-2 text-gray-900 group-hover:text-white text-lg">Phone</h4>
                                        <a 
                                            href="tel:+923227544521" 
                                            className="text-[#090447] group-hover:text-[#FFB900] font-bold transition-colors text-xl"
                                        >
                                            +92 322 7544521
                                        </a>
                                        <p className="text-gray-600 group-hover:text-gray-200 text-sm mt-2">Available 24/7 for your queries</p>
                                    </div>
                                </div>
                                ...
                                <div className="group flex items-start space-x-6 p-6 rounded-2xl bg-white hover:bg-gradient-to-r hover:from-[#090447] hover:to-[#0d0a5c] border border-gray-200 hover:border-[#FFB900] transition-all duration-500 transform hover:scale-105 shadow-lg hover:shadow-2xl">
                                    ...
                                    <div>
                                        <h4 className="font-bold mb-2 text-gray-900 group-hover:text-white text-lg">Email</h4>
                                        <a 
                                            href="mailto:amnasnetwork143@gmail.com" 
                                            className="text-[#090447] group-hover:text-[#FFB900] font-bold transition-colors text-lg break-all"
                                        >
                                            amnasnetwork143@gmail.com
                                        </a>
                                        <p className="text-gray-600 group-hover:text-gray-200 text-sm mt-2">We'll respond within 24 hours</p>
                                    </div>
                                </div>
                                ...
                                <div className="group flex items-start space-x-6 p-6 rounded-2xl bg-white hover:bg-gradient-to-r hover:from-[#090447] hover:to-[#0d0a5c] border border-gray-200 hover:border-[#FFB900] transition-all duration-500 transform hover:scale-105 shadow-lg hover:shadow-2xl">
                                    ...
                                    <div>
                                        <h4 className="font-bold mb-2 text-gray-900 group-hover:text-white text-lg">Address</h4>
                                        <p className="text-gray-700 group-hover:text-white text-lg leading-relaxed">
                        ...
                        <div data-aos="fade-left" data-aos-delay="200">
                            ...
                            <div className="mt-8 text-center">
                                <a
                                    ...
                                    className="inline-flex items-center space-x-3 px-8 py-4 bg-[#090447] hover:bg-[#070336] text-white font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 text-lg"
                                >
