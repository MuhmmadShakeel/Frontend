  ...
  return (
    <div className="px-4 md:px-16 py-12 bg-gray-50 min-h-screen">
      ...
      <div className="text-center mb-12" data-aos="fade-down">
        <button
          className="mb-3 px-4 py-2 border-2 border-[#00D5BE] cursor-pointer text-[#00D5BE] font-semibold rounded-lg hover:bg-[#00D5BE] hover:text-white transition"
      ...
      <div className="flex flex-col lg:flex-row gap-8 justify-center items-start">
        ...
        >
          ...
          <div className="flex mb-6 border-b border-gray-200">
            <button
              className={`flex-1 text-center py-2 font-semibold cursor-pointer ${paymentMethod==='bank' ? 'border-b-4 border-[#00D5BE] text-[#00D5BE]' : 'text-gray-500'}`}
              onClick={()=>setPaymentMethod('bank')}
            >
              Bank Transfer
            </button>
            <button
              className={`flex-1 text-center py-2 cursor-pointer font-semibold ${paymentMethod==='qr' ? 'border-b-4 border-[#00D5BE] text-[#00D5BE]' : 'text-gray-500'}`}
          ...
          {paymentMethod==='qr' && (
            <div className="text-center">
              <p className="text-gray-600 mb-4">Scan this QR code to pay <strong>{formatPrice(course.price)}</strong></p>
              <img
                src={qrcode}
                alt="QR Code"
          ...
          <div className="mt-6 text-center bg-green-50 p-4 rounded-lg shadow-sm hover:shadow-md transition">
            <h5 className="text-green-700 font-bold mb-2"><i className="bi bi-whatsapp me-2"></i>Send Confirmation</h5>
            <p className="text-gray-600 mb-4 text-sm md:text-base">After payment, send the screenshot to our WhatsApp for enrollment confirmation.</p>
            <button onClick={openWhatsApp} className="bg-green-600 text-white px-6 py-2 rounded-lg cursor-pointer hover:bg-green-700 transition">
